...
module.exports.interactCropImg = async function (host, port, protocol, target, walletJwk) {
  ...
  const cropImgId = await img.bundleInteraction({
    function: 'cropImg',
    imageData: 'dog.png',
    name: 'dog'
  }
  ...
  if (target == 'testnet') {
    ...
    console.log('upLoad tx id', cropImgId);
  }
};
